...
) ENGINE = InnoDB AUTO_INCREMENT = 103 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '聊天消息表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `t_message`  (
  ...
  INDEX `idx_create_time`(`create_time` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 39 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '消息通知表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_message` VALUES (27, 21, '新消息', '您有一条来自 李超 的新消息，点击查看', 3, 26, 0, '2026-03-04 17:52:43', '2026-03-04 17:52:43');
INSERT INTO `t_message` VALUES (28, 21, '新消息', '您有一条来自 李超 的新消息，点击查看', 3, 26, 0, '2026-03-04 17:54:04', '2026-03-04 17:54:04');
...
INSERT INTO `t_message` VALUES (31, 15, '订单支付成功', '您的订单 ORD20260304185836912371 已支付成功，等待跑腿员接单', 1, 27, 0, '2026-03-04 18:58:41', '2026-03-04 18:58:41');
INSERT INTO `t_message` VALUES (32, 15, '跑腿员已接单', '您的订单 ORD20260304185836912371 已被 泡泡 接单，请耐心等待', 1, 27, 0, '2026-03-04 18:59:08', '2026-03-04 18:59:08');
INSERT INTO `t_message` VALUES (33, 15, '新消息', '您有一条来自 泡泡 的新消息，点击查看', 3, 27, 0, '2026-03-04 19:01:03', '2026-03-04 19:01:03');
INSERT INTO `t_message` VALUES (34, 15, '新消息', '您有一条来自 泡泡 的新消息，点击查看', 3, 27, 0, '2026-03-04 19:01:16', '2026-03-04 19:01:16');
INSERT INTO `t_message` VALUES (35, 15, '新消息', '您有一条来自 泡泡 的新消息，点击查看', 3, 27, 0, '2026-03-04 19:01:33', '2026-03-04 19:01:33');
INSERT INTO `t_message` VALUES (36, 15, '订单已完成', '您的订单 ORD20260304185836912371 已完成，请对跑腿员进行评价', 1, 27, 0, '2026-03-04 19:01:42', '2026-03-04 19:01:42');
...
INSERT INTO `t_user` VALUES (15, NULL, '19216278622', 'mincer233', '$2a$10$wpbA3BSjYTfdu0n.7XnWROfOAMkS0St2.g992ISisWq4tm4DF01Ou', '李超', 'http://localhost:8088/api/uploads/avatars/user/a889ad6476704a459985fea9f5f2e874.jpg', 1, '2026-03-04', 1, 1, 11.00, '2026-02-28 14:32:00', '2026-02-28 14:32:00', 0, 0);
